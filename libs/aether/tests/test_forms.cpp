...
TEST_GROUP(BasicMonadTests){void setup() override{} void teardown() override{}};
...
TEST_GROUP(DynamicMonadTests){void setup() override{} void teardown()
                                  override{}};
...
TEST_GROUP(BytePackingTests){void setup() override{} void teardown()
                                 override{}};
