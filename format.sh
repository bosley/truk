...
case "$(uname -s)" in
  Linux)
    find "$ROOT" \
      \( -path "*/.git/*" -o -path "*/build/*" -o -path "*/cmake-build-*/*" -o -path "*/third_party/*" -o -path "*/external/*" -o -path "*/extern/*" -o -path "*/Extern/*" -o -path "*/vendor/*" -o -path "*/node_modules/*" -o -path "*/rll/*" \) -prune -o \
  ...
  Darwin)
    ...
    find "$ROOT" \
      \( -path "*/.git/*" -o -path "*/build/*" -o -path "*/cmake-build-*/*" -o -path "*/third_party/*" -o -path "*/external/*" -o -path "*/extern/*" -o -path "*/Extern/*" -o -path "*/vendor/*" -o -path "*/node_modules/*" -o -path "*/rll/*" \) -prune -o \
      \( -name "*.cpp" -o -name "*.cxx" -o -name "*.cc" -o -name "*.c" \) -type f -print0 | \
      xargs -0 -n 50 -P "$CPUS" clang-format -style=file -i
    ;;
  *)
    find "$ROOT" \
