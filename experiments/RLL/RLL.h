...
namespace exception {
////////////////////////////////////////////////////////////////////////////////
/// @brief A generic exception that simply denotes that the exception came from
/// RLL.
////////////////////////////////////////////////////////////////////////////////
...
public:
  ...
  ////////////////////////////////////////////////////////////////////////////////
  loader_flags(std::initializer_list<unix_flag> unix_flags,
               std::initializer_list<windows_flag> windows_flags);
...
public:
  ...
  bool has_symbol(const std::string &name) {
    return get_symbol_fast(name) != nullptr;
  }
...
//------------------------------RLL_DEFINITIONS-------------------------------//
#define RLL_DEFINE_EXCEPTION_W_METADATA(EXCP_NAME, METADATA_TYPE,              \
                                        METADATA_NAME, WHAT_RETURN)            \
  ...
  public:                                                                      \
    ...
    const char *what() const noexcept { WHAT_RETURN }                          \
  };
...
namespace exception {
////////////////////////////////////////////////////////////////////////////////
/// @brief If a symbol was not found in a shared library this exception is
/// thrown.
////////////////////////////////////////////////////////////////////////////////
RLL_DEFINE_EXCEPTION_W_METADATA(symbol_not_found, std::string, symbol_name,
...
////////////////////////////////////////////////////////////////////////////////
RLL_DEFINE_EXCEPTION_W_METADATA(library_already_loaded, std::string,
                                library_path, return library_path.c_str();)
////////////////////////////////////////////////////////////////////////////////
/// @brief If a accessor method is invoked but a shared library has no content
/// loaded into it this exception is thrown.
////////////////////////////////////////////////////////////////////////////////
RLL_DEFINE_EXCEPTION(
    library_not_loaded,
    return "A shared_library has not been loaded with content before use.";)
////////////////////////////////////////////////////////////////////////////////
/// @brief If an error occurred while loading content into a shared library this
/// exception is thrown.
////////////////////////////////////////////////////////////////////////////////
RLL_DEFINE_EXCEPTION_W_METADATA(
    library_loading_error, std::string, loading_error,
    return (loading_error != "" ? loading_error.c_str() : "Unknown Error.");)
} // namespace exception
...
loader_flags::loader_flags(std::initializer_list<unix_flag> unix_flags,
                           std::initializer_list<windows_flag> windows_flags) {
  uflags = 0;
  wflags = 0;
